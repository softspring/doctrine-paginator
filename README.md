...
[![CI](https://img.shields.io/github/actions/workflow/status/softspring/doctrine-paginator/ci.yml?branch=5.4&style=flat-square&label=CI)](https://github.com/softspring/doctrine-paginator/actions/workflows/ci.yml)
